...
public class Alta_Jornada extends javax.swing.JDialog {
    ...
    private void jButton_AnadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AnadirActionPerformed
        ...
        //Comprueba si ya existe la jornada introducida
        ArrayList numeroJornada = BaseDeDatos.getBD().ConsultaSQL("SELECT COUNT(*) FROM partido WHERE (idCompeticion=" + idCompeticion + ") AND (jornada=" + jornada + ")");
        ...
        while (numPartido < totalPartidos && esCorrecto) {
            String consulta = "INSERT INTO partido OVERRIDING SYSTEM VALUE VALUES (null," + idCompeticion + "," + jornada + ",";
